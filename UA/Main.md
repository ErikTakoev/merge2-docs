...
- **[Visual Effects](Visuals/Effects.md)**
  > **Контекст**: Система візуального зворотного зв'язку (Feedback). Перелік ефектів (Merge Hint, Highlight, Smoke) та способи їх виклику через компоненти `Effect`.
