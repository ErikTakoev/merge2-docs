...
- **[Scenario System](Features/Scenario.md)**
  > **Контекст**: Базова архітектура для створення сюжетних сценаріїв та квестів у Merge з використанням Unity Visual Scripting (UVS) та івент-орієнтованого підходу.

- **[Tutorial System](Features/Tutorials.md)**
  > **Контекст**: Архітектура туторіалів: керування покроковим навчанням (`ITutorialManager`), блокування вводу (`ITutorialInputBlocker`), підказки у вигляді руки (`TutorialHandHelper`) та вузли Unity Visual Scripting.
