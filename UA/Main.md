...
### Extension Guide
Як розширювати проєкт: додавати нові типи фішок, ефекти, взаємодії та сервіси.

- **[Extension Guide](ExtensionGuide.md)**
  > **Контекст**: Покрокове керівництво з розширення проєкту через VContainer, створення нових типів Chip, додавання ефектів та нових взаємодій.
