...
- **Виконання (`ExecuteInteraction`)**:
  ...
  - **Extra Chips**: Якщо в результаті злиття передбачений `ExtraChip`, система перевіряє шанс його випадіння та спавнить додаткову фішку на найближчу вільну комірку з анімацією `Generate`.
...
3. **`ExtraChip`**: Додаткова фішка, яка може бути отримана як бонус з певним шансом (**Chance**).
