...
- **`UpdateRuntimeData()`**: Синхронізує візуальний стан чіпа з його `RuntimeData`. Автоматично активує/деактивує `MoveLockedEffect` на основі властивості `IsMoveLocked`.
...
- **`OnDraggingChipWithMoveLocked()`**: Викликається при спробі перетягнути заблокований чіп. Відтворює анімацію `MoveLocked` на чіпі та його ефекті блокування, надаючи візуальний зворотний зв'язок гравцеві.
