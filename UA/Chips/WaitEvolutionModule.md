...
Логіка автоматичної еволюції фішки з часом реалізована за допомогою модульного компонента [WaitEvolutionModule](file:///Users/eriktakoev/Projects/MergeToolkit/merge2-unity/Assets/Expecto/MergeBase/Core/Scripts/Chips/WaitEvolutionModule.cs), який приєднується до базового GameObject фішки `Chip`. Компонент відстежує час очікування і після його закінчення замінює поточний чіп на інший випадковим чином згідно з заданими ймовірнісними вагами.
