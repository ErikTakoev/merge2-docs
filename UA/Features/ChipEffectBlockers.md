...
Блокування в Merge — це стан фішки, який забороняє певні ігрові дії (переміщення, злиття, генерацію тощо). Найчастіше блокування накладається через **Extra-ефекти** (ланцюги, коробки), які мають власні правила руйнування.
